...
function Aplicativos(Banco, Jogos, marca){
    this.Banco = Banco;
    this.Jogos = Jogos;
    this.appDoJoao = function(){
        return `O Joao tem um celular da marca ${this.marca}, do modelo ${celularDoJoao2.modelo}, na cor ${celularDoJoao2.cor} com ${celularDoJoao2.memoria} de memoria ram. E os apps instalados no celular dele é: ${aplicativosDoJoao.Banco} e ${aplicativosDoJoao.Jogos}`
    }
    Celular.call(this, marca)
}
...
const aplicativosDoJoao = new Aplicativos('NuBank', 'Jogo', 'Samsung')
